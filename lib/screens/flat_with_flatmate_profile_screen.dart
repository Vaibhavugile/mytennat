  ...
  Future<void> _submitProfileToFirebase() async {
    ...
    final profileData = {
      ...
      "moveInDate": _seekingFlatmateProfile.moveInDate != null
          ...
          : null,
      "budgetMin": int.tryParse(_seekingFlatmateProfile.budgetMin) ?? 0,
      "budgetMax": int.tryParse(_seekingFlatmateProfile.budgetMax) ?? 0,
      "preferredAreas": _seekingFlatmateProfile.areaPreference.split(',').map((e) => e.trim()).where((e) => e.isNotEmpty).toList(),
      ...
      "lookingFor": {
        "flatmateGender": _seekingFlatmateProfile.flatmateGenderPreference,
        ...
        "flatmateOccupation": _seekingFlatmateProfile.flatmateOccupationPreference.isNotEmpty ? [_seekingFlatmateProfile.flatmateOccupationPreference] : [],
        "importantQualities": _seekingFlatmateProfile.idealQualities,
        "dealBreakers": _seekingFlatmateProfile.dealBreakers,
        "flatRequirements": {
          "furnished": _seekingFlatmateProfile.furnishedUnfurnished,
          "attachedBathroom": _seekingFlatmateProfile.attachedBathroom ,
          "balcony": _seekingFlatmateProfile.balcony,
          "parking": _seekingFlatmateProfile.parking, // Covers car and two-wheeler
